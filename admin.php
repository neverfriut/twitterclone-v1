            ...
            <div id="myModal" class="modal">
                ...
                <div class="modal-content">
                    ...
                    <div class="tweetOuterDiv">
                        <form action="api-save-tweet.php"  method="POST">
                            <input type="text" name="tweetTitle" placeholder="What's happening">
                            <button>Tweet</button>
                        </form>
                    </div>
                </div>
...
<!-- END OF LEFT COLUMN --> 
        ...
        <div id="home" class="subpage">
            ...
            <div id="homepage">
                ...
                <svg id="selection-icon" viewBox="0 0 24 24">
                    <path
            ...
            <div id="tweet">
                <div class="profilePic"><img src="5.jpeg" alt=""></div>
                <div class="innerTweet">

                    <form action="api-save-tweet.php" class="formTweet" method="POST" >
                        <input type="text" name="tweetTitle" placeholder="What's happening?">
                        <button>Tweet</button>
                    </form>
                    ...
                    <svg viewBox="0 0 24 24"
                        class="r-13gxpu9 r-4qtqp9 r-yyy
                        <g>
        ...
        <div id="profile" class="subpage">
            ...
            <div>
                ...
                <h1>Edit or delete your tweets</h1>
                <p>This is where all your tweets are collected, <?= $_SESSION['firstname'];?></p>
                <a onclick="getTweets();">Get your tweets</a> 
